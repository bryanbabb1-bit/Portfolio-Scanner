...
from .routers import (
    advisor, backtest, breakouts, conviction, debate, devices, discovery,
    graph, insights, journal, learning, options, pins, plan, portfolio, risk,
    runner, scan, strategy, summary, watchpoints,
)
